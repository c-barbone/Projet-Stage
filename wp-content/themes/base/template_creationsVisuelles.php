    ...
    <div class="container-fluid">
            ...
            <?php $blockcreav = get_field("page_crea_vis");
                for ($i=0; $i < count($blockcreav); $i++){
                    echo'<div class="row align-items-center rowcréa"><div class="col-lg-6 col-sm-12  d-flex justify-content-center"><img class="img-fluid" src="'.$blockcreav[$i]["img_crea_vis"].'" alt=""></div>
